...
AI-powered supply chain risk assessment API that aggregates weather, news, and geopolitical data to score delivery risk in real time based on Retrieval Augmented Generation (RAG) architecture.
